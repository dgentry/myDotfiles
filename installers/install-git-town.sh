...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
	...
	curl -O -L https://github.com/Originate/git-town/releases/download/v7.4.0/git-town-amd64.deb
    ...
    curl -O -L https://github.com/Originate/git-town/releases/download/v7.4.0/git-town-linux-arm
