...
(custom-set-variables
 ...
 '(package-selected-packages
   '(seq gnuplot llm ellama magit ivy-hydra live-py-mode markdown-mode org-re-reveal hlinum magit-gh-pulls magithub highlight-doxygen crux fill-column-indicator ag all-the-icons anti-zenburn-theme arduino-cli-mode arduino-mode artbollocks-mode auto-package-update autopair bash-completion bitbake bug-hunter clang-format cmake-font-lock cmake-ide cmake-mode cmake-project color-theme-modern company-rtags concurrent counsel-projectile csound-mode cyberpunk-theme diminish doom-modeline dream-theme dumb-jump el-get eldoc-eval exec-path-from-shell exotica-theme f find-file-in-project flycheck-rtags flycheck-swiftx flycheck-yamllint flymake-cursor flymake-go flymake-shellcheck focus fold-dwim forecast fuzzy git-commit-insert-issue git-messenger git-walktree gnu-elpa-keyring-update go-mode google-maps google-this haml-mode hc-zenburn-theme helm-rtags hl-sentence idle-require iedit impatient-mode impatient-showdown irony irony-eldoc ivy ivy-rtags ivy-xref jedi jedi-core jedi-direx jenkins-watch jinja2-mode labburn-theme let-alist madhat2r-theme metar mo-git-blame modern-cpp-font-lock monochrome-theme mood-one-theme multi-web-mode multiple-cursors night-owl-theme nimbus-theme noctilux-theme northcode-theme nose nova-theme nyan-mode nyx-theme ob-ipython ob-shell on-screen org org-beautify-theme org-plus-contrib overcast-theme ox-html5slide ox-minutes ox-reveal ox-tufte paganini-theme plan9-theme planet-theme pydoc request-deferred reveal-in-osx-finder reykjavik-theme rtags selectric-mode seti-theme shrink-whitespace smart-compile soothe-theme sorcery-theme sos speech-tagger sphinx-doc spotify sublimity super-save swift-helpful swift-mode swift-playground-mode swiper ten-hundred-mode theme-changer tramp tree-sitter vagrant virtualenv visible-mark visual-fill-column warm-night-theme wordsmith-mode writegood-mode writeroom-mode xkcd yafolding ycmd zen-and-art-theme zenburn-theme zerodark-theme zweilight-theme))
