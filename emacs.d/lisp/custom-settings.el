...
\"###########.######\" };") t)
 ...
 '(package-selected-packages
   '(transient-cycles use-package ag all-the-icons anti-zenburn-theme arduino-cli-mode arduino-mode artbollocks-mode auto-package-update autopair bash-completion bitbake bug-hunter clang-format cmake-font-lock cmake-ide cmake-mode cmake-project color-theme-modern company-rtags concurrent counsel-projectile csound-mode cyberpunk-theme diminish doom-modeline dream-theme dumb-jump eglot el-get eldoc eldoc-eval ellama elpy erc exec-path-from-shell exotica-theme faceup fill-column-indicator find-file-in-project flycheck-rtags flycheck-swiftx flycheck-yamllint flymake flymake-cursor flymake-go flymake-shellcheck flymake-yaml flymake-yamllint focus fold-dwim forecast fuzzy git-commit-insert-issue git-messenger git-walktree gnu-elpa-keyring-update gnuplot go-mode google-maps google-this haml-mode hc-zenburn-theme helm-rtags highlight-doxygen hl-sentence hlinum idle-require idlwave iedit irony irony-eldoc ivy-hydra ivy-rtags ivy-xref jedi jedi-core jedi-direx jenkins-watch jinja2-mode jsonrpc labburn-theme let-alist madhat2r-theme magit-gh-pulls magithub mermaid-mode metar mo-git-blame modern-cpp-font-lock monochrome-theme mood-one-theme multi-web-mode multiple-cursors night-owl-theme nimbus-theme noctilux-theme northcode-theme nose nova-theme nyan-mode nyx-theme ob-ipython ob-shell on-screen org org-beautify-theme org-plus-contrib overcast-theme ox-html5slide ox-minutes ox-reveal ox-tufte paganini-theme plan9-theme planet-theme project pydoc request-deferred reveal-in-osx-finder reykjavik-theme selectric-mode seq seti-theme shrink-whitespace smart-compile soap-client soothe-theme sorcery-theme sos speech-tagger sphinx-doc spotify sublimity super-save swift-helpful swift-mode swift-playground-mode ten-hundred-mode theme-changer tramp tree-sitter use-package-ensure-system-package vagrant verilog-mode virtualenv visible-mark visual-fill-column warm-night-theme wordsmith-mode writegood-mode writeroom-mode xkcd xref xterm-color yafolding yaml-mode yaml-pro ycmd zen-and-art-theme zenburn-theme zerodark-theme zweilight-theme))
