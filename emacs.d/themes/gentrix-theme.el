;;; gentrix-theme.el --- gentrix theme

;; Copyright (C) 2003 by walterh@rocketmail.com
;; Copyright (C) 2013 by Syohei YOSHIDA
;; Copyright (C) 2020 by Dennis Gentry

;; Author: Dennis Gentry <dennis.gentry@gmail.com>
;; Version: 0.01
...
(custom-theme-set-faces
 ...
 '(default ((t (:background "black" :foreground "#2eee00"))))
 ...
 '(font-lock-builtin-face ((t (:foreground "color-28"))))
 '(font-lock-comment-face ((t (:italic t :foreground "color-245" :background "black" :slant italic))))
 '(font-lock-constant-face ((t (:bold))))
 '(font-lock-doc-face ((t (:foreground "white"))))
 '(font-lock-doc-string-face ((t (:foreground "white"))))
 '(font-lock-exit-face ((t (nil))))
 '(font-lock-function-name-face ((t (:bold t :underline nil :weight bold))))
 '(font-lock-keyword-face ((t (:foreground "color-28"))))
...
; '(font-lock-string-face ((t (:foreground "color-245"))))
; '(font-lock-string-face ((t (:foreground "#00eea2"))))
 '(font-lock-string-face ((t (:foreground "LightSkyBlue"))))
 '(font-lock-type-face ((t (:foreground "SlateBlue"))))
 '(font-lock-variable-name-face ((t (:foreground "color-178"))))
 ...
 '(show-paren-mismatch-face ((t (:underline nil))))
...
(provide-theme 'gentrix)

;;; gentrix-theme.el ends here
